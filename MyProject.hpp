...
struct Pipeline {
	...
	void reinit(BaseProject* bp, const std::string& VertShader, const std::string& FragShader,
		std::vector<DescriptorSetLayout*> D);
...
protected:
	...
	void createRenderPass() {
		...
		depthAttachment.format = VK_FORMAT_D32_SFLOAT; //findDepthFormat(); //
	...
	void drawFrame() {
		...
		//removed some parts from original tutorial because causes some error
		/*
	...
	virtual void localPipeCleanup() = 0;
...
void Pipeline::init(BaseProject* bp, const std::string& VertShader, const std::string& FragShader,
	...
	inputAssembly.primitiveRestartEnable = VK_FALSE; //VK_FALSE
...
void Pipeline::reinit(BaseProject* bp, const std::string& VertShader, const std::string& FragShader,
	std::vector<DescriptorSetLayout*> D) {
	BP = bp;
